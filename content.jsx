const ContentWorkspace = React.forwardRef(function ContentWorkspace({active, identity, locale, t, settings, setSettings, onConnect, onIdentity, failCopy, onAccountEvent}, ref) {
  ...
  function renderScreen() {
    ...
    if (route.page === 'read') return <ContentReader record={record} t={t} locale={locale} identity={identity} go={go} onExport={exportFile} failCopy={failCopy} records={data.records} drafts={data.drafts} onRevision={createRevision} />;
